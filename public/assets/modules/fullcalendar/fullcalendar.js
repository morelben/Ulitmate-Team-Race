...
var EventDef = /** @class */ (function () {
    ...
    EventDef.prototype.getConstraint = function () {
        ...
        return this.source.calendar.opt('eventConstraint'); // what about views option?
    };
    EventDef.prototype.getOverlap = function () {
        ...
        return this.source.calendar.opt('eventOverlap'); // what about views option?
    };
...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    InteractiveDateComponent.prototype.bindSegHandlerToEl = function (el, name, handler) {
        ...
        el.on(name, this.segSelector, function (ev) {
            var seg = $(ev.currentTarget).data('fc-seg'); // grab segment data. put there by views::renderEventsPayload
...
View.watch('title', ['dateProfile'], function (deps) {
    return (this.title = this.computeTitle(deps.dateProfile)); // assign to views for legacy reasons
});
...
var Calendar = /** @class */ (function () {
    ...
    // views
    // -----------------------------------------------------------------------------------------------------------------
    // Given a view name for a custom view or a standard view, creates a ready-to-go views object
...
var Component = /** @class */ (function (_super) {
    ...
    Component.prototype.removeElement = function () {
        ...
        this.el.remove();
        // NOTE: don't null-out this.el in case the views was destroyed within an API callback.
        // We don't null-out the views's other jQuery element references upon destroy,
    ...
    /*
    NOTE: Can't have a `render` method. Read the deprecation notice in views::executeDateRender
    */
...
var ViewSpecManager = /** @class */ (function () {
    ...
    ViewSpecManager.prototype.buildViewSpec = function (requestedViewType) {
        ...
        var duration;
        var unit;
        // iterate from the specific view definition to a more general one until we hit an actual views class
        while (viewType) {
